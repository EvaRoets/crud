...
<form action="index.php?edit=<?= $_GET['edit'] ?>" method="post">
    <fieldset>
        <legend>Change travel goal<?= $_GET['edit'] ?></legend>
        ...
        <input type="submit" name="edit" value="EDIT">
            ...
            <div class="form-row justify-content-center">
                <div class="form-group col-md-6">
                    <label for="changeActivity">Change activity</label>
                    <input type="text" id="changeActivity" name="changeActivity" class="form-control" placeholder="What do you want to do?" required />
                </div>
                <div></div>
            </div>
            <div class="form-row justify-content-center">
                <div class="form-group col-md-6">
                    ...
                    <select id="changeCountry" name="changeCountry" class="form-control"  placeholder="Where do you want to do it?" required/>
            ...
            <div class="form-row justify-content-center">
                <div class="form-group col-md-6">
                    <label for="changeSeason">Change season</label>
                    <input type="text" id="changeSeason" name="changeSeason" class="form-control" value=""
            ...
            <div class="form-row justify-content-center">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="changeComments" name="changeComments" class="form-control" value=""
            ...
            <div class="form-row justify-content-center">
                <div class="form-group col-md-6">
                    <input type="checkbox" id="changeDone" name="changeDone" class="form-control" value="done" required />
                    <label for="changeDone">Did it!🥳</label><br>
                    <input type="checkbox" id="changeNotDone" name="changeNotDone" value="changeNotDone" required >
                    <label for="changeNotDone">On my wishlist 🌠</label><br>
